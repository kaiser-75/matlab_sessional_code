function [t,y,z] = euler(dydt,tspan,y0,h)
...
y=y0(1)*ones(n,1);%preallocate y to improve efficiency
z=y0(2)*ones(n,1);
%% euler 2nd order ode solver
%% input only 2nd equation ; 1st equation is in already code
for i = 1:n-1 %implement Euler's method
    z(i+1)=z(i)+dydt(t(i),y(i))*(t(i+1)-t(i));
    y(i+1) = y(i) + z(i)*(t(i+1)-t(i));
end
