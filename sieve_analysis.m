...
%% excel data
Seive_size=S_size';
Mass_retained=Mass_rt';
Individual_retained=Indi_rt';
Cumulative_retained=Cum_rt';
Finer=total_pass';

data=table(Seive_size,Mass_retained,Individual_retained,Cumulative_retained,Finer);
writetable(data,'seive.xlsx');
