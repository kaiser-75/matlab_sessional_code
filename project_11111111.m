...
disp('1. Enter Type of load.For Point Load=0; UDL=1;Ramp load=2,Concntrated moment=3  ');
...
disp('If it is point load/conceentrated moement, then follow [1,2,4] ');
...
for i=1:noe
    ...
    elseif(loadvector(1,1)==1 || loadvector(1,1)==2) %ramp
        c=int16(l*100+1)-x*100;
        for j=1:c
            p=int16(x*100)+1;
